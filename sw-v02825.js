const CACHE='cruise-nav-v02825-dev15';
const CORE=['./','./index.html','./styles.css?v=02825','./app.js?v=02825','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
