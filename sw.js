const CACHE='cruise-nav-v093';
const CORE=['./','./index.html','./styles.css?v=093','./app.js?v=093','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html'];
