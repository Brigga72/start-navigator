const CACHE='cruise-nav-v021';
const CORE=['./','./index.html','./styles.css?v=021','./app.js?v=021','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
