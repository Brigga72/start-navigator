const CACHE='cruise-nav-v024';
const CORE=['./','./index.html','./styles.css?v=024','./app.js?v=024','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
