const CACHE='cruise-nav-v0271';
const CORE=['./','./index.html','./styles.css?v=0271','./app.js?v=0271','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
