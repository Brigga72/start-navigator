const CACHE='cruise-nav-v0282';
const CORE=['./','./index.html','./styles.css?v=0282','./app.js?v=0282','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
