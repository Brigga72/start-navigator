const CACHE='cruise-nav-v0283';
const CORE=['./','./index.html','./styles.css?v=0283','./app.js?v=0283','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
