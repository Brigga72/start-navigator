const CACHE='cruise-nav-v02813-dev1';
const CORE=['./','./index.html','./styles.css?v=02813','./app.js?v=02813','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
