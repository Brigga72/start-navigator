const CACHE='cruise-nav-v0274';
const CORE=['./','./index.html','./styles.css?v=0274','./app.js?v=0274','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
