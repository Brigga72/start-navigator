const CACHE='cruise-nav-v012';
const CORE=['./','./index.html','./styles.css?v=012','./app.js?v=012','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html'];
