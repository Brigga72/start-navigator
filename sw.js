const CACHE='cruise-nav-v094';
const CORE=['./','./index.html','./styles.css?v=094','./app.js?v=094','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html'];
