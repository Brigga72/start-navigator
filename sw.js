const CACHE='cruise-nav-v0286';
const CORE=['./','./index.html','./styles.css?v=0286','./app.js?v=0286','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
