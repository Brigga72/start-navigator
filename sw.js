const CACHE='cruise-nav-v010';
const CORE=['./','./index.html','./styles.css?v=010','./app.js?v=010','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html'];
