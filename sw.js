const CACHE='cruise-nav-v027';
const CORE=['./','./index.html','./styles.css?v=027','./app.js?v=027','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
