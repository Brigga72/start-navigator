const CACHE='cruise-nav-v023';
const CORE=['./','./index.html','./styles.css?v=023','./app.js?v=023','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
