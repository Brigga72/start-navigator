const CACHE='cruise-nav-v022';
const CORE=['./','./index.html','./styles.css?v=022','./app.js?v=022','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
