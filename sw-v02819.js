const CACHE='cruise-nav-v02819-dev9';
const CORE=['./','./index.html','./styles.css?v=02819','./app.js?v=02819','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
