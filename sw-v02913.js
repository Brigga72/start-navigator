const CACHE='cruise-nav-v02913';
const CORE=['./','./index.html','./styles.css?v=02913','./app.js?v=02913','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
