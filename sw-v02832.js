const CACHE='cruise-nav-v02832-dev22';
const CORE=['./','./index.html','./styles.css?v=02832','./app.js?v=02832','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
