const CACHE='cruise-nav-v02835-dev25';
const CORE=['./','./index.html','./styles.css?v=02835','./app.js?v=02835','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
