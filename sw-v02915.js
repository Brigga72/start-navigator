const CACHE='cruise-nav-v02915';
const CORE=['./','./index.html','./styles.css?v=02915','./app.js?v=02915','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
