const CACHE='cruise-nav-v02820-dev10';
const CORE=['./','./index.html','./styles.css?v=02820','./app.js?v=02820','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
