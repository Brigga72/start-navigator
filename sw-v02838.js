const CACHE='cruise-nav-v02838-dev28';
const CORE=['./','./index.html','./styles.css?v=02838','./app.js?v=02838','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
