const CACHE='cruise-nav-v02814-dev4';
const CORE=['./','./index.html','./styles.css?v=02814','./app.js?v=02814','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
