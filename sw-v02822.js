const CACHE='cruise-nav-v02822-dev12';
const CORE=['./','./index.html','./styles.css?v=02822','./app.js?v=02822','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
