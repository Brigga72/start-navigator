const CACHE='cruise-nav-v02817-dev7';
const CORE=['./','./index.html','./styles.css?v=02817','./app.js?v=02817','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
