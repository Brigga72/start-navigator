const CACHE='cruise-nav-v02826-dev16';
const CORE=['./','./index.html','./styles.css?v=02826','./app.js?v=02826','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
