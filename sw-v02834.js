const CACHE='cruise-nav-v02834-dev24';
const CORE=['./','./index.html','./styles.css?v=02834','./app.js?v=02834','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
