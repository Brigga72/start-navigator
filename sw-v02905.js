const CACHE='cruise-nav-v02905';
const CORE=['./','./index.html','./styles.css?v=02905','./app.js?v=02905','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
