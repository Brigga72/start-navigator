const CACHE='cruise-nav-v02816-dev6';
const CORE=['./','./index.html','./styles.css?v=02816','./app.js?v=02816','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
