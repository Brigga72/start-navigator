const CACHE='cruise-nav-v02818-dev8';
const CORE=['./','./index.html','./styles.css?v=02818','./app.js?v=02818','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
