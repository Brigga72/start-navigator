const CACHE='cruise-nav-v02833-dev23';
const CORE=['./','./index.html','./styles.css?v=02833','./app.js?v=02833','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
