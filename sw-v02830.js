const CACHE='cruise-nav-v02830-dev20';
const CORE=['./','./index.html','./styles.css?v=02830','./app.js?v=02830','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
