const CACHE='cruise-nav-v02906';
const CORE=['./','./index.html','./styles.css?v=02906','./app.js?v=02906','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
