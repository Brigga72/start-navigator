const CACHE='cruise-nav-v02815-dev4';
const CORE=['./','./index.html','./styles.css?v=02815','./app.js?v=02815','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
