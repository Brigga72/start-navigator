const CACHE='cruise-nav-v02829-dev19';
const CORE=['./','./index.html','./styles.css?v=02829','./app.js?v=02829','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
