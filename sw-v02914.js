const CACHE='cruise-nav-v02914';
const CORE=['./','./index.html','./styles.css?v=02914','./app.js?v=02914','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
