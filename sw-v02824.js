const CACHE='cruise-nav-v02824-dev14';
const CORE=['./','./index.html','./styles.css?v=02824','./app.js?v=02824','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
