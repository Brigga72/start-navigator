...
const CORE=['./','./index.html','./styles.css?v=02836','./app.js?v=02836','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
