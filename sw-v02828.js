const CACHE='cruise-nav-v02828-dev18';
const CORE=['./','./index.html','./styles.css?v=02828','./app.js?v=02828','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
