const CACHE='cruise-nav-v02821-dev11';
const CORE=['./','./index.html','./styles.css?v=02821','./app.js?v=02821','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
