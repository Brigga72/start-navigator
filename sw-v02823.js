const CACHE='cruise-nav-v02823-dev13';
const CORE=['./','./index.html','./styles.css?v=02823','./app.js?v=02823','./manifest.webmanifest','./icon-192.png','./icon-512.png','./version.json','./migrate.html','./assets/deck7-forward.png',
